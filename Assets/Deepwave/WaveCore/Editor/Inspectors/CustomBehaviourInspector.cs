...
{
    /// <summary>
    /// Custom Unity Inspector that enhances the appearance of MonoBehaviour and ScriptableObject inspectors.
    /// Draws a stylized branded header and bordered layout when an <see cref="InspectorHeaderAttribute"/> is present.
    /// </summary>
    [CustomEditor(typeof(MonoBehaviour), true), CanEditMultipleObjects]
    public sealed class CustomBehaviourInspector : UnityEditor.Editor
    {
        // ── Constants ─────────────────────────────────────────────────────
        ...
        /// <summary>Draws a branded header with the specified content.</summary>
